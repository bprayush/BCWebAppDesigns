	...
	<body style="background-color:#f5f5f5;font-family:Century Gothic;">
		...
		<div class="container">
			...
			<div class="row">
				...
				<img src="images/kasatlogo.jpg" style="float:left;width:32px;border-radius:50px;height:32px;">
				<span style="font-weight:bold;float:left;margin-left:8px;margin-top:3px;">Kastamandap School</span><br><br>
				<span style="float:left;margin-left:40px;"><img src="icons/placeholder.png" style="width:20px;">
					<span style="margin-left:5px;font-size:14px;font-style:italic;">
						New Road, Kathmandu
					</span>
				</span>
				<span style="float:right;"><img src="icons/calendar.png" style="width:20px;">
				...
				<div style="margin-left:130px;">
					<img src="icons/tick.png" style="width:16px;float:left;"> 
